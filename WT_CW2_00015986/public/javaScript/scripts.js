document.addEventListener("DOMContentLoaded", function () {
        ...
        axios
            ...
            .catch(function (error) {
                if (error.response && error.response.data) {
                    ...
                    showError("An error occurred. Please try again.", form_register);
                }
            });
    ...
    form_update.addEventListener("submit", function (e) {
        ...
        axios
            .post(`/api/user/update/${id}`, { fullname, phone_number, address, gender, birth_date, analysis })
            ...
            .catch(function (error) {
                if (error.response && error.response.data) {
                    ...
                    showError("An error occurred. Please try again.", form_update);
                }
            })
        })
    });
